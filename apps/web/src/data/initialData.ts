  ...
  categories: [
    {
      ...
      description: 'Drills, grinders, cutters, and electric power tools',
      productCount: 2,
      status: 'active',
    ...
    },
    {
      ...
      description: 'Tapes, screwdrivers, wrenches, hammers, and pliers',
      productCount: 2,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      description: 'LED lamps, switches, sockets, wires, and circuit breakers',
      productCount: 3,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      description: 'Wall paints, primer, wood glues, and sealants',
      productCount: 2,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      description: 'Fasteners, lubricants, rust protection, and safety gear',
      productCount: 1,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
  ...
  brands: [
    {
      ...
      description: 'German engineered power tools and industrial equipment',
      productCount: 1,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      description: 'Precision measuring tapes and durable hand tools',
      productCount: 1,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      description: 'Energy efficient LED lighting and electrical fixtures',
      productCount: 1,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    },
    {
      ...
      tenantId: 'tenant-city-retail',
      name: 'Asian Paints',
      description: 'Exterior & interior architectural coatings',
      productCount: 1,
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
  ...
  suppliers: [
    {
      id: 'sup-city-1',
      tenantId: 'tenant-city-retail',
      name: 'Apex Industrial Hardware Supplies',
      companyName: 'Apex Tools & Hardware Corp',
      phone: '+91 98422 10101',
      email: 'orders@apextools.in',
      address: '22 Cross Cut Road, Gandhipuram, Coimbatore',
      taxNumber: '33AABCA4433D1Z2',
      status: 'active',
      createdAt: '2026-01-20T09:00:00Z',
      updatedAt: '2026-01-20T09:00:00Z'
    }
  ...
  products: [
    {
      ...
      sku: 'DRL-500W',
      barcode: '890555001101',
      categoryId: 'cat-city-1',
      ...
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=300&auto=format&fit=crop&q=80',
    ...
    },
    {
      id: 'prod-city-2',
      tenantId: 'tenant-city-retail',
      name: 'Stanley 5M Steel Measuring Tape (Auto-Lock)',
      sku: 'TAP-5M',
      barcode: '890555001102',
      categoryId: 'cat-city-2',
      categoryName: 'Hand Tools & Measuring',
      costPrice: 180,
      sellingPrice: 299,
      stockQuantity: 35,
      minimumStock: 8,
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?w=300&auto=format&fit=crop&q=80',
      createdAt: '2026-01-20T10:00:00Z',
      updatedAt: '2026-09-08T11:00:00Z'
    },
    {
      id: 'prod-city-3',
      tenantId: 'tenant-city-retail',
      name: 'Taparia 8-Piece Magnetic Screwdriver Set',
      sku: 'SCR-8PC',
      barcode: '890555001103',
      categoryId: 'cat-city-2',
      categoryName: 'Hand Tools & Measuring',
      costPrice: 320,
      sellingPrice: 480,
      ...
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=300&auto=format&fit=crop&q=80',
      createdAt: '2026-01-20T10:00:00Z',
      updatedAt: '2026-09-08T11:00:00Z'
    },
    {
      id: 'prod-city-4',
      tenantId: 'tenant-city-retail',
      name: 'Philips 9W Cool Daylight LED Bulb B22 Base',
      sku: 'LED-9W',
      barcode: '890555001104',
      categoryId: 'cat-city-3',
      ...
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1550985543-f47f38aeee65?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1550985543-f47f38aeee65?w=300&auto=format&fit=crop&q=80',
    ...
    },
    {
      id: 'prod-city-5',
      tenantId: 'tenant-city-retail',
      name: 'Asian Paints Apex Weatherproof Emulsion White 4L',
      sku: 'PNT-APX-4L',
      barcode: '890555001105',
      categoryId: 'cat-city-4',
      categoryName: 'Paints & Adhesives',
      costPrice: 980,
      sellingPrice: 1350,
      stockQuantity: 8,
      minimumStock: 3,
      unit: 'pack',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=300&auto=format&fit=crop&q=80',
      createdAt: '2026-01-22T10:00:00Z',
      updatedAt: '2026-09-08T11:00:00Z'
    },
    {
      id: 'prod-city-6',
      tenantId: 'tenant-city-retail',
      name: 'Fevicol SH Synthetic Resin Wood Adhesive 1kg',
      sku: 'ADH-SH-1K',
      barcode: '890555001106',
      categoryId: 'cat-city-4',
      categoryName: 'Paints & Adhesives',
      costPrice: 210,
      sellingPrice: 290,
      ...
      unit: 'pack',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?w=300&auto=format&fit=crop&q=80',
    ...
    },
    {
      id: 'prod-city-7',
      tenantId: 'tenant-city-retail',
      name: 'Anchor Roma 16A 3-Pin Modular Switch & Socket Combo',
      sku: 'SW-ROM-16A',
      barcode: '890555001107',
      categoryId: 'cat-city-3',
      categoryName: 'Electricals & Lighting',
      costPrice: 140,
      sellingPrice: 220,
      ...
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=300&auto=format&fit=crop&q=80',
      createdAt: '2026-01-25T10:00:00Z',
      updatedAt: '2026-09-08T11:00:00Z'
    },
    {
      id: 'prod-city-8',
      tenantId: 'tenant-city-retail',
      name: 'WD-40 Multi-Use Rust Remover & Lubricant Spray 400ml',
      sku: 'WD40-400ML',
      barcode: '890555001108',
      categoryId: 'cat-city-5',
      categoryName: 'Hardware & Maintenance',
      costPrice: 280,
      sellingPrice: 390,
      stockQuantity: 18,
      minimumStock: 5,
      unit: 'pcs',
      status: 'active',
      imagePath: 'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?w=1000&auto=format&fit=crop&q=80',
      thumbnailPath: 'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?w=300&auto=format&fit=crop&q=80',
...
export const XYZ_RESTAURANT_DATA: TenantData = {
  ...
  // Tables
  restaurantTables: [
    { id: 'tbl-1', sectionId: 'sec-gf', tableNumber: 'T-01', capacity: 4, status: 'seated', shape: 'square', guestCount: 3, captainName: 'Captain Suresh', currentBillTotal: 1240, seatedAt: '2026-09-20T12:45:00Z', activeOrderId: 'ord-xyz-101', activeKotIds: ['kot-100'] },
    ...
    { id: 'tbl-5', sectionId: 'sec-gf', tableNumber: 'T-05', capacity: 2, status: 'billed', shape: 'round', guestCount: 2, captainName: 'Captain Meera', currentBillTotal: 950, seatedAt: '2026-09-20T12:00:00Z', activeOrderId: 'ord-xyz-104', activeKotIds: ['kot-104'] },
    ...
    { id: 'tbl-9', sectionId: 'sec-terrace', tableNumber: 'TR-01', capacity: 4, status: 'seated', shape: 'round', guestCount: 2, captainName: 'Captain Vikram', currentBillTotal: 1550, seatedAt: '2026-09-20T13:00:00Z', activeOrderId: 'ord-xyz-105', activeKotIds: ['kot-105'] },
    ...
    { id: 'tbl-12', sectionId: 'sec-bar', tableNumber: 'BAR-01', capacity: 2, status: 'served', shape: 'round', guestCount: 2, captainName: 'Captain Arun', currentBillTotal: 750, seatedAt: '2026-09-20T12:40:00Z', activeOrderId: 'ord-xyz-107', activeKotIds: ['kot-107'] },
  ...
  restaurantKots: [
    {
      ...
      status: 'served',
      firedAt: new Date(Date.now() - 35 * 60 * 1000).toISOString(),
      servedAt: new Date(Date.now() - 15 * 60 * 1000).toISOString(),
      items: [
        { id: 'ki-0a', menuItemId: 'menu-1', name: 'Paneer Butter Masala', quantity: 2, unitPrice: 340, station: 'kitchen', status: 'served' },
        { id: 'ki-0b', menuItemId: 'menu-5', name: 'Garlic Butter Naan', quantity: 4, unitPrice: 75, station: 'tandoor', status: 'served' },
        { id: 'ki-0c', menuItemId: 'menu-9', name: 'Desi Masala Craft Soda', quantity: 2, unitPrice: 120, station: 'bar', status: 'served' }
      ]
    },
    {
      id: 'kot-101',
      ...
      items: [
        ...
        { id: 'ki-2', menuItemId: 'menu-4', name: 'Dal Makhani Bukhara', quantity: 2, unitPrice: 290, station: 'kitchen', status: 'cooking' },
        { id: 'ki-3', menuItemId: 'menu-5', name: 'Garlic Butter Naan', quantity: 6, unitPrice: 75, station: 'tandoor', status: 'pending' },
        { id: 'ki-3b', menuItemId: 'menu-2', name: 'Dum Mutton Biryani', quantity: 2, unitPrice: 480, station: 'kitchen', status: 'cooking' }
      ]
    },
    {
      id: 'kot-102',
    ...
    },
    {
      ...
      captainName: 'Captain Meera',
      status: 'served',
      firedAt: new Date(Date.now() - 48 * 60 * 1000).toISOString(),
      servedAt: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
      items: [
        { id: 'ki-4a', menuItemId: 'menu-4', name: 'Dal Makhani Bukhara', quantity: 2, unitPrice: 290, station: 'kitchen', status: 'served' },
        { id: 'ki-4b', menuItemId: 'menu-6', name: 'Tandoori Butter Roti', quantity: 4, unitPrice: 40, station: 'tandoor', status: 'served' },
        { id: 'ki-4c', menuItemId: 'menu-7', name: 'Alphonso Mango Kulfi', quantity: 1, unitPrice: 180, station: 'dessert', status: 'served' }
      ]
    },
    {
      id: 'kot-105',
      ...
      status: 'served',
      firedAt: new Date(Date.now() - 25 * 60 * 1000).toISOString(),
      servedAt: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
      items: [
        { id: 'ki-5a', menuItemId: 'menu-3', name: 'Murgh Malai Tikka', quantity: 2, unitPrice: 390, station: 'tandoor', status: 'served' },
        { id: 'ki-5b', menuItemId: 'menu-2', name: 'Dum Mutton Biryani', quantity: 1, unitPrice: 480, station: 'kitchen', status: 'served' },
        { id: 'ki-5c', menuItemId: 'menu-8', name: 'Classic Virgin Mojito', quantity: 1, unitPrice: 220, station: 'bar', status: 'served' }
      ]
    },
    {
      id: 'kot-103',
      ...
      items: [
        ...
        { id: 'ki-10', menuItemId: 'menu-5', name: 'Garlic Butter Naan', quantity: 6, unitPrice: 75, station: 'tandoor', status: 'cooking' }
      ]
    },
    {
      id: 'kot-107',
      ...
      station: 'bar',
      captainName: 'Captain Arun',
      status: 'served',
      firedAt: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
      servedAt: new Date(Date.now() - 8 * 60 * 1000).toISOString(),
      items: [
        { id: 'ki-7a', menuItemId: 'menu-8', name: 'Classic Virgin Mojito', quantity: 2, unitPrice: 220, station: 'bar', status: 'served' },
        { id: 'ki-7b', menuItemId: 'menu-9', name: 'Desi Masala Craft Soda', quantity: 2, unitPrice: 120, station: 'bar', status: 'served' }
      ]
    }
  ],

  // Active and Settled Orders
  restaurantOrders: [
    {
      id: 'ord-xyz-101',
      orderNumber: 'ORD-101',
    ...
    },
    {
      ...
      roundOff: 0,
      grandTotal: 1638,
      payments: [{ method: 'upi', amount: 1638 }],
      orderStatus: 'settled',
      billPrintedCount: 1,
      reprintHistory: [],
      createdAt: '2026-09-20T10:30:00Z',
      settledAt: '2026-09-20T11:45:00Z'
    },
    {
      id: 'ord-xyz-settled-2',
      orderNumber: 'ORD-099',
      orderType: 'dine_in',
      tableId: 'tbl-10',
      tableNumber: 'TR-02',
      ...
      roundOff: 0,
      grandTotal: 2331,
      payments: [{ method: 'card', amount: 2331 }],
      orderStatus: 'settled',
      billPrintedCount: 1,
      reprintHistory: [],
      createdAt: '2026-09-20T11:00:00Z',
      settledAt: '2026-09-20T12:15:00Z'
    }
  ],
