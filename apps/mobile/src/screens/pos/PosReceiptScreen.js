...
const Share = ReactNative.Share;
import { theme } from '../../theme';
import { Icon } from '../../components/common/Icon';
import { Button } from '../../components/common/Button';
import { generateUpiQrImageUrl } from '../../utils/mobileUpiQr';
export const PosReceiptScreen = ({ route, navigation }) => {
    ...
    const qrImageUrl = generateUpiQrImageUrl('kumarsupermarket@okaxis', invoice.tenantName, invoice.grandTotal, invoice.invoiceNumber, 180);
    ...
    const handlePrint = () => {
        Alert.alert('Thermal Printer Connected', `Sent 80mm ESC/POS command to Bluetooth thermal printer for invoice ${invoice.invoiceNumber}.`);
    };
    return (<SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.receiptCanvas}>
          ...
          <View style={styles.metaSection}>
            ...
            {invoice.customerName && (<View style={styles.metaRow}>
                <Text style={styles.metaLabel}>Customer:</Text>
                <Text style={styles.metaValBold}>{invoice.customerName}</Text>
              </View>)}
            {invoice.customerPhone && (<View style={styles.metaRow}>
                <Text style={styles.metaLabel}>Phone:</Text>
                <Text style={styles.metaVal}>{invoice.customerPhone}</Text>
              </View>)}
            {invoice.customerGstin && (<View style={styles.metaRow}>
          ...
          <View style={styles.itemsSection}>
            ...
            {invoice.items.map((item, idx) => (<View key={idx} style={styles.tableDataRow}>
                <View style={{ flex: 5 }}>
          ...
          <View style={styles.totalsSection}>
            ...
            {invoice.totalDiscount > 0 && (<View style={styles.calcRow}>
          ...
          {/* HSN Summary Table */}
          {invoice.hsnSummary && invoice.hsnSummary.length > 0 && (<View style={styles.hsnSection}>
              ...
              {invoice.hsnSummary.map((h, i) => (<View key={i} style={styles.hsnDataRow}>
        ...
        <View style={styles.actionsBar}>
          <Button label="Print (80mm Thermal)" variant="primary" onPress={handlePrint} style={{ flex: 1 }}/>
          <Button label="Done" variant="outline" onPress={() => navigation.navigate('PosTerminal')} style={{ width: 100 }}/>
        </View>
      </ScrollView>
    </SafeAreaView>);
};
...
//# sourceMappingURL=PosReceiptScreen.js.map