...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, SafeAreaView, Image, StatusBar } from 'react-native';
import { theme } from '../../theme';
import { Icon } from '../../components/common/Icon';
import { Badge } from '../../components/common/Badge';
import { AppHeader } from '../../components/layout/AppHeader';
import { useTenant } from '../../context/TenantContext';
export const StockScreen = ({ navigation, route }) => {
    ...
    const filtered = products.filter(p => {
        ...
        if (filter === 'low')
            return p.stockQuantity > 0 && p.stockQuantity <= p.minimumStock;
        if (filter === 'out')
    ...
    return (<SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.tabContainer}>
        ...
        ].map(tab => (<TouchableOpacity key={tab.key} style={[styles.tab, filter === tab.key && styles.tabActive]} onPress={() => setFilter(tab.key)}>
            ...
            return (<View style={styles.card}>
              ...
              <View style={{ flex: 1, marginLeft: 12 }}>
                ...
                <View style={styles.statusRow}>
                  <Badge label={isOut ? 'Depleted' : isLow ? 'Low Stock' : 'In Stock'} variant={isOut ? 'danger' : isLow ? 'warning' : 'success'} size="sm"/>
              ...
              <TouchableOpacity style={styles.adjustBtn} onPress={() => navigation.navigate('StockAdjustment', { product: item })}>
...
//# sourceMappingURL=StockScreen.js.map