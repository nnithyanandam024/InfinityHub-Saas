...
export const StockAdjustmentScreen = ({ route, navigation }) => {
    ...
    const handleSave = () => {
        ...
        Alert.alert('Stock Adjusted', `${product.name} stock updated to ${simulated} ${product.unit}`, [{ text: 'OK', onPress: () => navigation.goBack() }]);
    };
    return (<SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.toggleRow}>
          <TouchableOpacity style={[styles.toggleBtn, type === 'increase' && styles.toggleBtnActiveAdd]} onPress={() => setType('increase')} activeOpacity={0.8}>
          ...
          <TouchableOpacity style={[styles.toggleBtn, type === 'decrease' && styles.toggleBtnActiveDeduct]} onPress={() => setType('decrease')} activeOpacity={0.8}>
        ...
        <View style={styles.stepperRow}>
          {[1, 5, 10, 25, 50].map(val => (<TouchableOpacity key={val} style={[styles.stepperChip, qty === String(val) && styles.stepperChipActive]} onPress={() => setQty(String(val))}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput style={styles.input} keyboardType="number-pad" value={qty} onChangeText={setQty} placeholder="0"/>
        </View>
        ...
        <View style={styles.reasonList}>
          {REASON_PRESETS.map((r, idx) => (<TouchableOpacity key={idx} style={[styles.reasonChip, reason === r && styles.reasonChipActive]} onPress={() => setReason(r)}>
        ...
        <Button label={`Confirm & Update Stock to ${simulated} ${product.unit}`} onPress={handleSave} variant="primary" size="lg" style={{ marginTop: 16 }}/>
      </ScrollView>
    </SafeAreaView>);
};
...
//# sourceMappingURL=StockAdjustmentScreen.js.map