...
export const AppCatalogScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
        ...
        {APPS_LIST.map(app => (
          <View key={app.id} style={styles.appCard}>
            <View style={styles.appCardHeader}>
              ...
              <Badge
                label={app.status === 'active' ? 'Active' : app.status === 'ready' ? 'Ready' : 'Preview'}
                variant={app.status === 'active' ? 'success' : app.status === 'ready' ? 'primary' : 'muted'}
                size="sm"
              />
            </View>
