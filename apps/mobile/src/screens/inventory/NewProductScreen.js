...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, SafeAreaView, ScrollView, Image, Alert, StatusBar } from 'react-native';
...
export const NewProductScreen = ({ navigation }) => {
    ...
    return (<SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput style={styles.input} placeholder="e.g. Matte Silicone Protective Case" placeholderTextColor={theme.colors.muted} value={name} onChangeText={setName}/>
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.photoRow}>
            ...
            return (<TouchableOpacity key={idx} style={[styles.photoCard, isSelected && styles.photoCardActive]} onPress={() => setSelectedPhoto(p.url)} activeOpacity={0.75}>
        ...
        <View style={styles.inputGroup}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 6 }}>
            {categories.map(c => (<TouchableOpacity key={c.id} style={[styles.catChip, categoryId === c.id && styles.catChipActive]} onPress={() => setCategoryId(c.id)}>
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.inputGroup, { flex: 1 }]}>
            ...
            <TextInput style={styles.input} keyboardType="numeric" value={costPrice} onChangeText={setCostPrice}/>
          </View>
        </View>
        ...
        <View style={styles.row}>
          <View style={[styles.inputGroup, { flex: 1 }]}>
            ...
            <TextInput style={styles.input} keyboardType="number-pad" value={stockQuantity} onChangeText={setStockQuantity}/>
          </View>

          <View style={[styles.inputGroup, { flex: 1 }]}>
            <Text style={styles.label}>Min Buffer</Text>
            <TextInput style={styles.input} keyboardType="number-pad" value={minimumStock} onChangeText={setMinimumStock}/>
          </View>
        ...
        <Button label="Save Product to Catalog" onPress={handleSave} variant="primary" size="lg" style={{ marginTop: 12 }}/>
      </ScrollView>
    </SafeAreaView>);
};
...
//# sourceMappingURL=NewProductScreen.js.map