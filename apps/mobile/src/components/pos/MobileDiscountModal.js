...
export const MobileDiscountModal = ({ visible, onClose, subtotal, currentDiscount, onApplyDiscount }) => {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.backdrop}>
        ...
        <View style={styles.sheet}>
          ...
          <View style={styles.toggleRow}>
            <TouchableOpacity style={[styles.toggleBtn, discountType === 'percent' && styles.toggleBtnActive]} onPress={() => setDiscountType('percent')} activeOpacity={0.8}>
              <Text style={[styles.toggleText, discountType === 'percent' && styles.toggleTextActive]}>
                Percentage (%)
              </Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.toggleBtn, discountType === 'flat' && styles.toggleBtnActive]} onPress={() => setDiscountType('flat')} activeOpacity={0.8}>
          ...
          <View style={styles.presetRow}>
            {(discountType === 'percent' ? [5, 10, 15, 20] : [50, 100, 200, 500]).map(val => (<TouchableOpacity key={val} style={[styles.chip, numVal === val && styles.chipActive]} onPress={() => handlePreset(val)}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} placeholder={discountType === 'percent' ? 'Enter percentage (e.g. 10)' : 'Enter rupee amount'} placeholderTextColor={theme.colors.muted} keyboardType="numeric" value={inputValue} onChangeText={setInputValue} autoFocus/>
          </View>

          {/* Supervisor Warning */}
          {isSupervisorRequired && (<View style={styles.warningBox}>
          ...
          <View style={styles.actionRow}>
            {currentDiscount && (<Button label="Remove" variant="outline" onPress={handleRemove} style={styles.removeBtn}/>)}
            <Button label="Apply Discount" variant="primary" onPress={handleApply} style={{ flex: 1 }}/>
          </View>
        </View>
...
//# sourceMappingURL=MobileDiscountModal.js.map