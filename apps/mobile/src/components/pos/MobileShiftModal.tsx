...
export const MobileShiftModal: React.FC<MobileShiftModalProps> = ({
  ...
  const [amountInput, setAmountInput] = useState<string>(mode === 'open' ? '1500' : '');
        ...
        <View style={styles.sheet}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder={mode === 'open' ? 'e.g. 1500' : 'Enter counted cash'}
          ...
          {mode === 'close' && amountInput.length > 0 && (
            <View style={[styles.varianceBox, variance === 0 ? styles.varBalanced : variance > 0 ? styles.varOver : styles.varShort]}>
          ...
          <View style={[styles.inputContainer, { height: 60, alignItems: 'flex-start', paddingTop: 8 }]}>
            <TextInput
              ...
              placeholder="e.g. Starting register float, denominations verified"
              placeholderTextColor={theme.colors.muted}
              value={notes}
          ...
          <View style={styles.actions}>
            <Button
              label={isSubmitting ? 'Submitting...' : mode === 'open' ? 'Confirm & Open Shift' : 'Reconcile & Close Shift'}
