...
export const SplashScreen = ({ onFinish, minDisplayMs = 1500 }) => {
      ...
      <View style={styles.centerGroup}>
        ...
        <Animated.View style={[
          ...
          <View style={[styles.emblemInner, { backgroundColor: brandColor }]}>
            {logoUrl ? (<Image source={{ uri: logoUrl }} style={{ width: 44, height: 44, borderRadius: 12 }} resizeMode="contain"/>) : (<Icon name="package" size={32} color="#FFFFFF"/>)}
          </View>
        </Animated.View>
