...
export const Icon = ({ name, size = 20, color = '#0F172A', style }) => {
    const s = size;
    switch (name) {
        case 'home':
            return (<View style={[{ width: s, height: s, alignItems: 'center', justifyContent: 'flex-end' }, style]}>
          <View style={{
                    width: 0,
                    height: 0,
        ...
        case 'package':
        case 'store':
            return (<View style={[{ width: s, height: s, alignItems: 'center', justifyContent: 'center' }, style]}>
          <View style={{
                    width: s * 0.85,
                    height: s * 0.85,
                    borderWidth: 1.8,
        ...
        case 'barcode':
            return (<View style={[{ width: s, height: s, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }, style]}>
        ...
        case 'stock':
            return (<View style={[{ width: s, height: s, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', gap: 2.5 }, style]}>
        ...
        case 'grid':
            return (<View style={[{ width: s, height: s, justifyContent: 'center', alignItems: 'center' }, style]}>
        ...
        case 'list':
            return (<View style={[{ width: s, height: s, justifyContent: 'center', gap: 3 }, style]}>
        ...
        case 'appLauncher':
            return (<View style={[{ width: s, height: s, justifyContent: 'center', alignItems: 'center', gap: 2.5 }, style]}>
