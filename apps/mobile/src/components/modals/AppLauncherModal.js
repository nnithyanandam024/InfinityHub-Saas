...
export const AppLauncherModal = ({ visible, onClose, onSelectApp }) => {
      ...
      <TouchableOpacity style={styles.backdrop} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} style={{ width: '100%' }}>
          <View style={styles.sheet}>
            ...
            return (<TouchableOpacity key={app.id} style={[styles.item, isActive && styles.itemActive]} onPress={() => handleSelect(app.id)} activeOpacity={0.75}>
                      <View style={[styles.iconWrap, isActive && styles.iconWrapActive]}>
                        <Icon name={app.icon} size={20} color={isActive ? theme.colors.primary : theme.colors.body}/>
                      </View>
...
//# sourceMappingURL=AppLauncherModal.js.map