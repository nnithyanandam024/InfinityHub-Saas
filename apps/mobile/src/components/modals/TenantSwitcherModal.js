      ...
      <TouchableOpacity style={styles.backdrop} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} style={{ width: '100%' }}>
          <View style={styles.sheet}>
            ...
            return (<TouchableOpacity key={t.id} style={[styles.item, isActive && styles.itemActive]} onPress={() => handleSelect(t.id, t.name)} activeOpacity={0.7}>
                      ...
                      {isActive && (<View style={styles.checkWrap}>
...
//# sourceMappingURL=TenantSwitcherModal.js.map