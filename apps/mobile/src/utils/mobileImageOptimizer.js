...
export const mobileImageOptimizer = {
     ...
     */
    calculateScaledDimensions(originalWidth, originalHeight, maxDimension) {
     ...
     */
    async prepareForUpload(productId, imageUri, originalWidth = 1920, originalHeight = 1080) {
...
//# sourceMappingURL=mobileImageOptimizer.js.map