export const theme = {
  ...
  typography: {
    h1: { fontSize: 22, fontWeight: '700' as const, color: '#0F172A' },
    h2: { fontSize: 18, fontWeight: '700' as const, color: '#0F172A' },
    h3: { fontSize: 15, fontWeight: '600' as const, color: '#0F172A' },
    body: { fontSize: 14, fontWeight: '400' as const, color: '#475569' },
    bodyBold: { fontSize: 14, fontWeight: '600' as const, color: '#0F172A' },
